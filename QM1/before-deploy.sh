...
openssl req -new -nodes -out MQ/tls/qm1.csr -newkey rsa:4096 -keyout MQ/tls/qm1.key -subj '/CN=QM1' -addext "subjectAltName = DNS:registryqm1-ibm-mq-qm-cp4i.apps.itz-9zfzru.osv.techzone.ibm.com"
